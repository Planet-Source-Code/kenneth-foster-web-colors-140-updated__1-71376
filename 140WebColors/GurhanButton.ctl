    ...
    Else
        ...
        If m_PicturePosition = gbLEFT Then
            ...
            With mvarCaptionRect
                ...
                Else
                .Top = (((mvarClientRect.Bottom - mvarClientRect.Top) - capHeight) \ 2) + mvarClientRect.Top + 1
                .Left = mvarPictureRect.Right + mvarPadding + 1
                End If
        ...
        ElseIf m_PicturePosition = gbRIGHT Then
            With mvarCaptionRect
                ...
                Else
                .Top = (((mvarClientRect.Bottom - mvarClientRect.Top) - capHeight) \ 2) + mvarClientRect.Top + 1
                .Left = (((mvarClientRect.Right - mvarClientRect.Left) - (picWidth + mvarPadding + capWidth)) \ 2) + mvarClientRect.Left + 1
                End If
                .Bottom = mvarCaptionRect.Top + capHeight
                .Right = mvarCaptionRect.Left + capWidth
            End With
        ...
        ElseIf m_PicturePosition = gbTOP Then
            ...
            With mvarCaptionRect
                ...
                Else
                .Top = mvarPictureRect.Bottom + mvarPadding + 1
                .Left = (((mvarClientRect.Right - mvarClientRect.Left) - capWidth) \ 2) + mvarClientRect.Left + 1
                End If
                .Bottom = mvarCaptionRect.Top + capHeight
                .Right = mvarCaptionRect.Left + capWidth
            End With
        ElseIf m_PicturePosition = gbBOTTOM Then
            With mvarCaptionRect
                ...
                .Left = (((mvarClientRect.Right - mvarClientRect.Left) - capWidth) \ 2) + mvarClientRect.Left
                Else
                .Top = (((mvarClientRect.Bottom - mvarClientRect.Top) - (picHeight + mvarPadding + capHeight)) \ 2) + mvarClientRect.Top + 1
                .Left = (((mvarClientRect.Right - mvarClientRect.Left) - capWidth) \ 2) + mvarClientRect.Left + 1
                End If
                .Bottom = mvarCaptionRect.Top + capHeight
                .Right = mvarCaptionRect.Left + capWidth
